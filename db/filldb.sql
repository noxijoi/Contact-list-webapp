...
INSERT INTO contact (f_name, l_name, p_name, b_date, sex, nationality, marital_status,
                     ...
                     VALUES ("Иванов", "Иван", "Иванович","1990.10.10","male","Беларусь", "single",null,"ivanov@gmail.com","EPAM",
                             "Беларусь","Минск","Независимости","122a",220000);
INSERT INTO contact (f_name, l_name, p_name, b_date, sex, nationality, marital_status,
                     web_site, email, company,
                     country, city, street, house_n, post_index)
                     VALUES ("Петров", "Петр", "Петрович","1995.2.12","male","Беларусь", "divorced","petr.by","petrov@gmail.com","iTransiton",
